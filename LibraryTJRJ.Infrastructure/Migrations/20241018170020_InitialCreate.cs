        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Publisher = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    Edition = table.Column<int>(type: "INTEGER", nullable: false),
                    YearPublication = table.Column<string>(type: "TEXT", maxLength: 4, nullable: false),
                    CreatedDateTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedDateTime = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookSubjects", x => new { x.BooksId, x.SubjectsId });
                    table.ForeignKey(
                        name: "FK_BookSubjects_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookSubjects_Subjects_SubjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookSubjects_SubjectsId",
                table: "BookSubjects",
                column: "SubjectsId");
